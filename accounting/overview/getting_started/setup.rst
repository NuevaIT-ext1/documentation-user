...
- **Code**: This code is linked to your Journal's *Short Code*, as displayed on Odoo. Select the
  right Journal to autofill this field.
- **Journal**: Select the *Journal* you want to use to record the financial transactions linked to
  this bank account or create a new one by clicking on *Create and Edit*.
